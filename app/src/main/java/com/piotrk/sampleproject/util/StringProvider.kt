package com.piotrk.sampleproject.util
...
class ContextStringProvider(private val context: Context) : StringProvider {
    ...
    override fun getQuantityString(textId: Int, count: Int, vararg objects: Any) = context.resources.getQuantityString(textId, count, *objects)
